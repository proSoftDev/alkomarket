...
use app\models\search\PricesSearch;
...
class PricesController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            $check = Prices::find()->where('filial_id='.$model->filial_id.' AND product_id='.$model->product_id)->all();
            if(count($check)==null){
                ...
                Yii::$app->getSession()->setFlash('prices', 'Цена уже создано!');
