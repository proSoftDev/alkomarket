...
<main class="main">
    ...
    <div class="catalog-products">
        <div class="container">
            <div class="title">
                <a href="/site/all-catalog?id=<?=$model->id;?>">Все товары на одной странице</a>
                <h3><?=$model->name?></h3>
            </div>
...
<script>
    ...
    $('body').on('click', '.orderByCheap',function(e){
        ...
        e.preventDefault();
        $.ajax({
            url: '/site/catalog-order-by-cheap',
            data: {id:id},
            type: 'GET',
    ...
    $('body').on('click', '.orderByExpensive',function(e){
        ...
        e.preventDefault();
        $.ajax({
            url: '/site/catalog-order-by-expensive',
            data: {id:id},
            type: 'GET',
            success: function (response) {
                $('.catalog_pagination').html(response);
    ...
    $('body').on('click', '.countries',function(e){
        ...
        e.preventDefault();
        $.ajax({
            url: '/site/catalog-get-by-country',
    ...
    $('body').on('click', '.between_prices',function(e){
        ...
        e.preventDefault();
        $.ajax({
            url: '/site/catalog-get-between-prices',
	...
	$('body').on('click', '.card-continue',function(e){
        $('#basket-popup').hide();
    });
